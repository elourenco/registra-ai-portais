...
export function RequestsPage() {
  ...
  return (
    <section className="space-y-6">
      <PageHeader
        title="Solicitações"
        description="Solicitações são o motor do workflow. Cada item transforma uma pendência em ação objetiva para supplier ou comprador."
        actions={
          <>
      ...
      <Card>
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              {workspaceQuery.data?.requests.map((item) => (
